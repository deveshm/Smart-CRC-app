...
Scenario: As a user, I want to view the events assocaiated with an install
 ...
 Scenario: As a user, I want to update the notes of event
    ...
    When I update the note of the event to be "this is a note"
    Then a event should exist with note: "this is a note"
